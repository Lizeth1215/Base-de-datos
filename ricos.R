...
truehist(Edad)
plot(main ="Edad de las 100 personas más ricas del mundo" # Título)
...
plot(nerve_ecdf, verticals=TRUE, do.points=FALSE, main="Edad de las 100 personas más ricas del mundo",
     xlab="Edad", ylab="Número de personas",
     col="black")
